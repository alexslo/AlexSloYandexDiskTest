...
public class ListPhotoframeLoader extends AsyncTaskLoader<List<ListItem>> {

    private static String TAG = "ListExampleLoader";

    private Credentials credentials;
    private String dir;
    private String preferMediaType = "image";
    ...
    public ListPhotoframeLoader(Context context, Credentials credentials, String dir) {
        super(context);
        handler = new Handler();
                ...
                public boolean handleItem(ListItem item) {
                    if (ignoreFirstItem) {
                        ignoreFirstItem = false;
                            ...
                            (!item.isCollection() && preferMediaType.equals(item.getMediaType()))) {
